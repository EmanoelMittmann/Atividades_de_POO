               ...
               switch (operador)
                {
                    ...
                    case "1":
                        ...
                        var retorno = clienteServico.newClient(nome, telefone);
                        Console.WriteLine(retorno);
                        Console.WriteLine("");
                        break;
                    case "2":
                        Console.WriteLine("Escolha o id do usuário a ser editado");
                        var contatos = clienteServico.retornarlista();
                    ...
                    break;
                    case "3":
                        var retorno3 = clienteServico.retornarlista();
                        Console.WriteLine(retorno3);
                    break;
                    case "4":
                        Console.WriteLine("Escolha o id do usuário a ser removido");
                        var todosContatos = clienteServico.retornarlista();
                        ...
                        var retorno6 = clienteServico.delete(idContatoRemoverInt);
